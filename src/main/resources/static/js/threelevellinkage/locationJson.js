...
Location.prototype.fillOption = function (el_id, loc_id, selected_id) {
    ...
    console.log("========el_id=============" + el_id + "  ========loc_id=============" + loc_id + "  ========loc_id=============" + selected_id);
    var el = $('#' + el_id);
...
Location.prototype.fillAndSelectOption = function (form, province, city, arae) {

    //设置省的值
    if (province) {
        this.fillOption('loc_province', '0');
        $("#loc_province").val(province);
        form.render('select');
        if (city) {
            this.fillOption('loc_city', '0,' + province, city);
            $("#loc_city").val(city);
            form.render('select');
            if (arae) {
                this.fillOption('loc_town', '0,' + province + ',' + city, arae);
                $("#loc_town").val(arae);
                form.render('select');
            }
        }
