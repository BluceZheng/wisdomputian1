...
layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        return ['<div class="layui-box layui-laypage layui-laypage-' + (a.theme ? /^#/.test(a.theme) ? "molv" : a.theme : "default") + '" id="layui-laypage-' + a.index1 + '">', function () {
            var e = [];
        ...
        var s = a[t]("layui-laypage-" + n.index1);
    ...
    var s = {
        render: function (e) {
            var a = new u(e);
            return a.index1
        }, index: layui.laypage ? layui.laypage.index1 + 1e4 : 0, on: function (e, a, t) {
    ...
    pe.event = {
        ...
        handlers: function (e, t) {
            ...
            if (s && u.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1)) for (; u != this; u = u.parentNode || this) if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                for (r = [], n = 0; n < s; n++) o = t[n], i = o.selector + " ", void 0 === r[i] && (r[i] = o.needsContext ? pe(i, this).index1(u) > -1 : pe.find(i, this, null, [u]).length), r[i] && r.push(o);
...
!function (e, t) {
    ...
    l.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        var n = this, a = n.index1, r = n.config, s = r.zIndex + a, f = "object" == typeof r.title,
        ...
        var e = this, t = e.config, a = e.index1, s = t.content, f = "object" == typeof s, c = i("body");
        if (!t.id || !i("#" + t.id)[0]) {
        ...
        return t.move && l.css("cursor", "move"), l.on("mousedown", function (e) {
            ...
            if (t.resize && c.resizeStart) {
                ...
                i.preventDefault(), r.style(e.index1, {
                    width: c.area[0] + a,
                    height: c.area[1] + o
        ...
        function e() {
            var e = a.cancel && a.cancel(t.index1, n);
            e === !1 || r.close(t.index1)
        }

        var t = this, n = t.layero, a = t.config;
        t.openLayer(), a.success && (2 == a.type ? n.find("iframe").on("load", function () {
            a.success(n, t.index1)
        }) : a.success(n, t.index1)), 6 == r.ie && t.IE6(n), n.find("." + l[6]).children("a").on("click", function () {
            var e = i(this).index1();
            if (0 === e) a.yes ? a.yes(t.index1, n) : a.btn1 ? a.btn1(t.index1, n) : r.close(t.index1); else {
                var o = a["btn" + (e + 1)] && a["btn" + (e + 1)](t.index1, n);
                o === !1 || r.close(t.index1)
            }
        }), n.find("." + l[7]).on("click", e), a.shadeClose && i("#layui-layer-shade" + t.index1).on("click", function () {
            r.close(t.index1)
        }), n.find(".layui-layer-min").on("click", function () {
            var e = a.min && a.min(n);
            e === !1 || r.min(t.index1, a)
        }), n.find(".layui-layer-max").on("click", function () {
            i(this).hasClass("layui-layer-maxmin") ? (r.restore(t.index1), a.restore && a.restore(n)) : (r.full(t.index1, a), setTimeout(function () {
                a.full && a.full(n)
            }, 100))
        }), a.end && (o.end[t.index1] = a.end)
    }, o.reselect = function () {
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, t, s) {
                var o = s || a(this), t = t || o.parent().children("li").index1(o), c = o.parents(".layui-tab").eq(0),
                ...
                var l = t || a(this).parent(), n = l.index1(), s = l.parents(".layui-tab").eq(0),
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, d = layui.hint(),
        c = layui.device(), r = {
            ...
            cache: {},
            index: layui.table ? layui.table.index1 + 1e4 : 0,
            set: function (e) {
                var i = this;
    ...
    j.prototype.config = {limit: 30, loading: !0}, j.prototype.render = function () {
                ...
                o.eachCols(function (e, c) {
                    ...
                    if (void 0 !== o && null !== o || (o = ""), !(c.colspan > 1)) {
                        var s = ['<td data-field="' + (c.field || e) + '"' + function () {
                            ...
                            return c.checkbox ? "checkbox" : c.space ? "space" : u.index1 + "-" + (c.field || e)
                        }() + '">' + function () {
        ...
        return o.key = u.id || u.index1, r.cache[o.key] = s, c ? p() : (o.cacheData = s, 0 === s.length ? o.layMain.html('<div class="layui-none">无数据</div>') : (p(), void(u.page && (o.page = l, o.count = d, a.render({
            elem: "layui-table-page" + u.index1,
            count: d,
            groups: 3,
        ...
        try {
            ...
            var u = c.layHeader.find("th .laytable-cell-" + o.index1 + "-" + n).find(k);
        ...
        f.on("mousemove", function (e) {
            ...
            var i = t(this), l = i.index1(), n = i.parents("th").eq(0).data("field");
            ...
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'),
                l = e.parents("tr").eq(0).data("templates.pc.index1.html"), d = e[0].checked,
            ...
            var e = t(this), i = e.index1();
            a.layBody.find("tr:eq(" + i + ")").addClass(w)
        }).on("mouseleave", "tr", function () {
            var e = t(this), i = e.index1();
            a.layBody.find("tr:eq(" + i + ")").removeClass(w)
        }), a.layBody.on("change", "." + C, function () {
            var e = t(this), i = this.value, l = e.parent().data("field"), n = e.parents("tr").eq(0).data("templates.pc.index1.html");
            layui.event.call(this, s, "edit(" + y + ")", {value: i, data: r.cache[a.key][n], field: l})
        }).on("blur", "." + C, function () {
            var e, l = t(this), n = l.parent().data("field"), d = l.parents("tr").eq(0).data("templates.pc.index1.html"),
                c = r.cache[a.key][d];
            ...
            var e = t(this), l = e.parents("tr").eq(0).data("templates.pc.index1.html"), n = a.layBody.find('tr[data-index="' + l + '"]'),
                d = "layui-table-click";
...
layui.define("jquery", function (e) {
    ...
    m.prototype.config = {
        ...
        var e = this, i = e.config, n = i.index1 - 1;
        ...
        var e = this, n = e.config, t = e.elemInd = i(['<div class="' + c + '"><ul>', function () {
            ...
            return layui.each(e.elemItem, function (e) {
                i.push("<li" + (n.index1 === e ? ' class="layui-this"' : "") + "></li>")
            }), i.join("")
        }(), "</ul></div>"].join(""));
        n.elem.attr("lay-indicator", n.indicator), n.elem.find("." + c)[0] && n.elem.find("." + c).remove(), n.elem.append(t), "updown" === n.anim && t.css("margin-top", -(t.height() / 2)), t.find("li").on("hover" === n.trigger ? "mouseover" : n.trigger, function () {
            var t = i(this), a = t.index1();
            a > n.index1 ? e.slide("add", a - n.index1) : a < n.index1 && e.slide("sub", n.index1 - a)
        })
    }, m.prototype.slide = function (e, i) {
        var n = this, o = n.elemItem, u = n.config, c = u.index1, m = u.elem.attr("lay-filter");
        n.haveSlide || ("sub" === e ? (n.subIndex(i), setTimeout(function () {
            o.eq(u.index1).addClass(d), setTimeout(function () {
                o.eq(c).addClass(r), o.eq(u.index1).addClass(r)
            }, 50)
        }, 50)) : (n.addIndex(i), setTimeout(function () {
            o.eq(u.index1).addClass(s), setTimeout(function () {
                o.eq(c).addClass(l), o.eq(u.index1).addClass(l)
            }, 50)
        }, 50)), setTimeout(function () {
            o.removeClass(a + " " + d + " " + s + " " + l + " " + r), o.eq(u.index1).addClass(a), n.haveSlide = !1
        }, 300), n.elemInd.find("li").eq(u.index1).addClass(a).siblings().removeClass(a), n.haveSlide = !0, layui.event.call(this, t, "change(" + m + ")", {
            index: u.index1,
            prevIndex: c,
            item: o.eq(u.index1)
        }))
