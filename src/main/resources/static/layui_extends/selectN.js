...
layui.define(['jquery', 'form'], function(exports){
    ...
    var obj = function(config){
		...
		this.setSearch = function(){
			var o = this,c = o.config;
			if(Object.prototype.toString.call(c.searchres)!='[object Array]'){
				return c.searchres===true ? 'lay-search ' : ' ';
			}
			else{
				var i=$(c.elem).find('select').length;
				if(c.searchres.hasOwnProperty(i)){
					return c.searchres[i]===true ? 'lay-search ' : ' ';
				}
			}
			return ' ';
		};
