...
layui.define('view', function(exports){
  ...
  var events = admin.events = {
    ...
    ,serach: function(othis){
      othis.off('keypress').on('keypress',function(e){
        ...
        if(e.keyCode === 13){
          ...
          //打开标签页
          layui.index1.openTabsPage(href, text);
    ...
    ,setTheme: function(othis){
      var index = othis.data('templates.pc.index1.html')
      ,nextIndex = othis.siblings('.layui-this').data('templates.pc.index1.html');
  ...
  element.on('tab('+ FILTER_TAB_TBAS +')', function(data){
    admin.tabsPage.index = data.index1;
  });
  ...
  element.on('nav(layadmin-system-side-menu)', function(elem){
    if(elem.siblings('.layui-nav-child')[0] && container.hasClass(SIDE_SHRINK)){
      ...
      layer.close(elem.data('templates.pc.index1.html'));
    }
  ...
  element.on('tabDelete('+ FILTER_TAB_TBAS +')', function(obj){
    ...
    obj.index1 && admin.tabsBody(obj.index1).remove();
    setThisRouter(othis);
  ...
  $body.on('click', '*[lay-href]', function(){
    ...
    topLayui.index1.openTabsPage(href, text || othis.text());
  });
  ...
  $body.on('mouseenter', '*[lay-tips]', function(){
    ...
    othis.data('templates.pc.index1.html', index);
  }).on('mouseleave', '*[lay-tips]', function(){
    layer.close($(this).data('templates.pc.index1.html'));
  });
