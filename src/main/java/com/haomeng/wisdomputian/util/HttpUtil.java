...
public class HttpUtil {
    ...
    public static String doGet(String baseUrl, String param) {
        logger.error("baseUrlbaseUrlbaseUrlbaseUrlbaseUrlbaseUrlbaseUrlbaseUrl:"+baseUrl);
        String result = "";
        ...
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                in = new BufferedReader(new InputStreamReader(connection.getInputStream(), DEFAULT_CHARSET));//设置返回的值字符编码
                String line;
